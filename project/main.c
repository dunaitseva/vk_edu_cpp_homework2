...
#define REQ_ARGS 3
#define ERR_USAGE_MSG "Usage: two command line argument file with input matrix and output file."
...
void free_res(FILE *input, FILE *output, matrix_t *matrix, matrix_t *transposed) {
  if (input != NULL) {
	fclose(input);
  }
